			...
			React.createElement("section", null, 
				React.createElement("table", null, 
					React.createElement("tr", null, 
						...
						React.createElement("td", null, React.createElement("img", {src: ""}), React.createElement("h3", null, "something 4"), React.createElement("p", null))
					), 
					React.createElement("tr", null, 
						React.createElement("td", null, React.createElement("img", {src: ""}), React.createElement("h3", null, "effective search bar"), React.createElement("p", null)), 
						React.createElement("td", null, React.createElement("img", {src: ""}), React.createElement("h3", null, "effective search bar"), React.createElement("p", null))
					)
				)
			)
