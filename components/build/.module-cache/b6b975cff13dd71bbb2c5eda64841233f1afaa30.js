		...
		return(
			React.createElement("section", null, 
				React.createElement("table", null, 
					...
					React.createElement("tr", null, 
						React.createElement("td", null, React.createElement("h2", null, "1"), "Use Mobile App to easily push thoughts (including images, text, audio) "), 
						React.createElement("td", null, React.createElement("h2", null, "2"), "Use Mobile App to easily push thoughts (including images, text, audio)")
					)
				)
			)
		);
